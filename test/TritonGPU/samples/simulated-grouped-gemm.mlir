...
// CHECK:             %[[VAL_68:.*]]:10 = scf.if %[[VAL_67]] -> (!tt.tensordesc<128x64xf16, #[[$ATTR_2]]>, !tt.tensordesc<256x64xf16, #[[$ATTR_2]]>, !tt.tensordesc<128x256xf16, #[[$ATTR_2]]>, i32, i32, i32, i32, i32, i32, i32) {
...
// CHECK:               %[[VAL_72:.*]]:6 = scf.if %[[VAL_70]] -> (!tt.tensordesc<128x64xf16, #[[$ATTR_2]]>, !tt.tensordesc<256x64xf16, #[[$ATTR_2]]>, !tt.tensordesc<128x256xf16, #[[$ATTR_2]]>, i32, i32, i32) {
...
// CHECK:                 scf.yield %[[VAL_77]], %[[VAL_85]], %[[VAL_93]], %[[VAL_80]], %[[VAL_88]], %[[VAL_96]] : !tt.tensordesc<128x64xf16, #[[$ATTR_2]]>, !tt.tensordesc<256x64xf16, #[[$ATTR_2]]>, !tt.tensordesc<128x256xf16, #[[$ATTR_2]]>, i32, i32, i32
// CHECK:               } else {
// CHECK:                 scf.yield %[[VAL_52]], %[[VAL_53]], %[[VAL_54]], %[[VAL_61]], %[[VAL_62]], %[[VAL_63]] : !tt.tensordesc<128x64xf16, #[[$ATTR_2]]>, !tt.tensordesc<256x64xf16, #[[$ATTR_2]]>, !tt.tensordesc<128x256xf16, #[[$ATTR_2]]>, i32, i32, i32
// CHECK:               }
...
// CHECK:               scf.yield %[[VAL_108:.*]]#0, %[[VAL_108]]#1, %[[VAL_108]]#2, %[[VAL_97]], %[[VAL_71]], %[[VAL_106]], %[[VAL_107]], %[[VAL_108]]#3, %[[VAL_108]]#4, %[[VAL_108]]#5 : !tt.tensordesc<128x64xf16, #[[$ATTR_2]]>, !tt.tensordesc<256x64xf16, #[[$ATTR_2]]>, !tt.tensordesc<128x256xf16, #[[$ATTR_2]]>, i32, i32, i32, i32, i32, i32, i32
// CHECK:             } else {
// CHECK:               scf.yield %[[VAL_52]], %[[VAL_53]], %[[VAL_54]], %[[VAL_55]], %[[VAL_56]], %[[VAL_57]], %[[VAL_58]], %[[VAL_61]], %[[VAL_62]], %[[VAL_63]] : !tt.tensordesc<128x64xf16, #[[$ATTR_2]]>, !tt.tensordesc<256x64xf16, #[[$ATTR_2]]>, !tt.tensordesc<128x256xf16, #[[$ATTR_2]]>, i32, i32, i32, i32, i32, i32, i32
// CHECK:             }
// CHECK:             %[[VAL_109:.*]] = arith.muli %[[VAL_66]], %[[VAL_16]] : i32
// CHECK:             %[[VAL_110:.*]] = tt.descriptor_load %[[VAL_111:.*]]#0{{\[}}%[[VAL_111]]#5, %[[VAL_109]]] : !tt.tensordesc<128x64xf16, #[[$ATTR_2]]> -> tensor<128x64xf16, #[[$ATTR_0]]>
// CHECK:             %[[VAL_112:.*]] = ttg.local_alloc %[[VAL_110]] : (tensor<128x64xf16, #[[$ATTR_0]]>) -> !ttg.memdesc<128x64xf16, #[[$ATTR_2]], #[[$ATTR_4]]>
// CHECK:             %[[VAL_113:.*]] = tt.descriptor_load %[[VAL_111]]#1{{\[}}%[[VAL_111]]#6, %[[VAL_109]]] : !tt.tensordesc<256x64xf16, #[[$ATTR_2]]> -> tensor<256x64xf16, #[[$ATTR_0]]>
...
// CHECK:             }
// CHECK:             scf.yield %[[VAL_66]], %[[VAL_111]]#0, %[[VAL_111]]#1, %[[VAL_111]]#2, %[[VAL_111]]#3, %[[VAL_111]]#4, %[[VAL_111]]#5, %[[VAL_111]]#6, %[[VAL_117]]#0, %[[VAL_119]], %[[VAL_111]]#7, %[[VAL_111]]#8, %[[VAL_111]]#9 : i32, !tt.tensordesc<128x64xf16, #[[$ATTR_2]]>, !tt.tensordesc<256x64xf16, #[[$ATTR_2]]>, !tt.tensordesc<128x256xf16, #[[$ATTR_2]]>, i32, i32, i32, i32, tensor<128x256xf32, #[[$ATTR_1]]>, i1, i32, i32, i32
// CHECK:           }
...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 8 : i32, ttg.target = "cuda:sm90a", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @matmul_kernel_descriptor_persistent(%arg0: !tt.ptr<f16> {tt.divisibility = 16 : i32}, %arg1: !tt.ptr<f16> {tt.divisibility = 16 : i32}, %arg2: !tt.ptr<f16> {tt.divisibility = 16 : i32}, %arg3: i32 {tt.divisibility = 16 : i32}, %arg4: i32 {tt.divisibility = 16 : i32}, %arg5: i32 {tt.divisibility = 16 : i32}) {
    ...
    %22:10 = scf.for %arg6 = %c0_i32 to %20 step %c1_i32 iter_args(%arg7 = %c-1_i32, %arg8 = %9, %arg9 = %10, %arg10 = %12, %arg11 = %17, %arg12 = %c-1_i32, %arg13 = %c0_i32, %arg14 = %c0_i32, %arg15 = %cst, %arg16 = %false) -> (i32, !tt.tensordesc<128x64xf16, #nvmma_128>, !tt.tensordesc<256x64xf16, #nvmma_128>, !tt.tensordesc<128x256xf16, #nvmma_128>, i32, i32, i32, i32, tensor<128x256xf32, #ttg.nvidia_mma<{versionMajor = 3, versionMinor = 0, warpsPerCTA = [8, 1], instrShape = [16, 256, 16]}>>, i1)  : i32 {
      ...
      %27:7 = scf.if %26 -> (!tt.tensordesc<128x64xf16, #nvmma_128>, !tt.tensordesc<256x64xf16, #nvmma_128>, !tt.tensordesc<128x256xf16, #nvmma_128>, i32, i32, i32, i32) {
        ...
        scf.yield %39#0, %39#1, %39#2, %40, %39#3, %49, %50 : !tt.tensordesc<128x64xf16, #nvmma_128>, !tt.tensordesc<256x64xf16, #nvmma_128>, !tt.tensordesc<128x256xf16, #nvmma_128>, i32, i32, i32, i32
      } else {
        scf.yield %arg8, %arg9, %arg10, %arg11, %arg12, %arg13, %arg14 : !tt.tensordesc<128x64xf16, #nvmma_128>, !tt.tensordesc<256x64xf16, #nvmma_128>, !tt.tensordesc<128x256xf16, #nvmma_128>, i32, i32, i32, i32
      } {loop.cluster = 0 : i32, loop.stage = 0 : i32}
      %28 = arith.muli %25, %c64_i32 {loop.cluster = 2 : i32, loop.stage = 0 : i32} : i32
      %29 = tt.descriptor_load %27#0[%27#5, %28] {loop.cluster = 2 : i32, loop.stage = 0 : i32} : !tt.tensordesc<128x64xf16, #nvmma_128> -> tensor<128x64xf16, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [1, 32], warpsPerCTA = [4, 2], order = [1, 0]}>>
      ...
      %31 = tt.descriptor_load %27#1[%27#6, %28] {loop.cluster = 2 : i32, loop.stage = 0 : i32} : !tt.tensordesc<256x64xf16, #nvmma_128> -> tensor<256x64xf16, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [1, 32], warpsPerCTA = [4, 2], order = [1, 0]}>>
      ...
      %36 = scf.if %35 -> (i1) {
        ...
        tt.descriptor_store %27#2[%27#5, %27#6], %38 : !tt.tensordesc<128x256xf16, #nvmma_128>, tensor<128x256xf16, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [1, 32], warpsPerCTA = [1, 8], order = [1, 0]}>>
        scf.yield %false : i1
      } else {
        scf.yield %true : i1
      } {loop.cluster = 3 : i32, loop.stage = 2 : i32}
      scf.yield %25, %27#0, %27#1, %27#2, %27#3, %27#4, %27#5, %27#6, %34, %36 : i32, !tt.tensordesc<128x64xf16, #nvmma_128>, !tt.tensordesc<256x64xf16, #nvmma_128>, !tt.tensordesc<128x256xf16, #nvmma_128>, i32, i32, i32, i32, tensor<128x256xf32, #ttg.nvidia_mma<{versionMajor = 3, versionMinor = 0, warpsPerCTA = [8, 1], instrShape = [16, 256, 16]}>>, i1
    }
    tt.return
  }
}
