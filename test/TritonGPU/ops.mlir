...
module attributes {"ttg.target" = "cuda:sm0", "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, "ttg.threads-per-warp" = 32 : i32} {
...
#smem = #ttg.shared_memory
module attributes {"ttg.target" = "cuda:sm0", "ttg.num-ctas" = 2 : i32, "ttg.num-warps" = 1 : i32, "ttg.threads-per-warp" = 32 : i32} {
