// RUN: triton-opt %s -convert-triton-to-tritongpu=target=cuda:sm80 -tritongpu-remove-layout-conversions -tritongpu-assign-latencies -tritongpu-schedule-loops -tritongpu-pipeline=num-stages=3 -canonicalize -test-print-allocation 2>&1 | FileCheck %s
